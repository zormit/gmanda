...
public class Pair<P, V> {
	...
	/**
	 * Given a list of pairs, will return a list where pairs containing the same P will be merged together to
	 * form a pair with this P and a list of all the Vs associated with this P.
	 * 
	 * This operation is garantueed to be stable (the ordering of pairs with the same P is unaltered).
	 * 
	 * @param <P>
	 * @param <V>
	 * @param list
	...
	public String toString() {
		return new StringBuffer().append('<').append(p).append(',').append(v).append('>')
			.toString();
	}
