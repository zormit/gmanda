...
public class NoCollectionListListenerAdapter<T> implements ListListener<T> {

	NoCollectionListListener<T> listener;
	
	public NoCollectionListListenerAdapter(NoCollectionListListener<T> listener){
