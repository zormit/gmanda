...
public class CodeNode extends FixNamedNode {
	
	CodeModel p;
	String code;
	
	public CodeNode(JNode parent, CodeModel p, String code){
		super(parent, code);
		this.p = p;
		this.code = code;
	}
	...
	public List<JNode> getChildren() {
		...
		if (children == null){
			children = new ArrayList<JNode>(p.getPrimaryDocuments(code).size());
			
			for (PrimaryDocument child : p.getPrimaryDocuments(code)){
