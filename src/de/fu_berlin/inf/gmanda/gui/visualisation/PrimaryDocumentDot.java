...
public class PrimaryDocumentDot extends PNode implements Comparable<PrimaryDocumentDot> {
	...
	public PrimaryDocumentDot(PrimaryDocument pd, CodedString colors, ColorMapper mapper) {
		...
		Point2D[] points = new Point2D[]{new Point2D.Double(0.0f, 7.0f), new Point2D.Double(-5.0f, 7.0f),
			new Point2D.Double(0.0f, 0.0f), new Point2D.Double(5.0f, 7.0f), new Point2D.Double(0.0f, 7.0f)};
