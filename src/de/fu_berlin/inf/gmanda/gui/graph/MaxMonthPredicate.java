 ...
 */
public class MaxMonthPredicate implements Predicate<Node> {

	int maxMonth;

	MaxMonthPredicate(int maxMonth) {
		this.maxMonth = maxMonth;
	}

	@Override
	public boolean apply(Node a) {
		return a.months.getNonZeroBins() <= maxMonth;
	}

	public String toString() {
		return "<= " + maxMonth + " of 12 month present in the project";
	}
}